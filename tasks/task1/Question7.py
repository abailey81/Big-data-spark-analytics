...
# Sort by 'average_tip_per_passenger' in descending order and take top 10
taxi_top_10_routes_df = taxi_grouped_df.orderBy(col("average_tip_per_passenger").desc()).limit(10)

# Show the results without truncating fields (taking the first 10 rows)
taxi_top_10_routes_df.select(
